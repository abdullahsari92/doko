...
import * as objectPath from 'object-path';// Layout
...
export class AsideLeftComponent implements OnInit, AfterViewInit {
	...
	ngOnInit() {
		...
		this.getYetkiler();
		console.log('menuList',this.menuAsideService.menuList$);
	...
	getYetkiler()
	{
		...
		this.yetkiTanimService.getAuthCanView(1).subscribe(res => {
		 var yetkiTanim = res.data;
		 console.log('getAuthCanView',res);
		  })
	}
}
