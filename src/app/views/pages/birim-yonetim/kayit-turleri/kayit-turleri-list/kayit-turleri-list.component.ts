...
@Component({
  selector: 'kt-kayit-turleri-list',
  templateUrl: './kayit-turleri-list.component.html',
  styleUrls: ['./kayit-turleri-list.component.scss']
})
export class KayitTurleriListComponent implements OnInit {
  ...
  getList()
  {
    ...
    this.BirimYonetimService.getListRecord().subscribe(res=>{
  ...
  remove(data)
  {
      ...
      var waitDesciption =this.translate.instant('TEXT.DELETE_SUCCESSFUL');
        ...
        dialogRef.afterClosed().subscribe(refData => {
              ...
              this.BirimYonetimService.removeRecord(data.id).subscribe(res=>{
  ...
  { 
      ...
      this.columnDefs = [
        ...
        { field: 'adi_tr' ,   headerName:this.translate.instant("TEXT.adi_tr"),  minWidth: 175, filter: true,  headerCheckboxSelection: true, headerCheckboxSelectionFilteredOnly: true,  checkboxSelection: true, },
        ...
        { field: 'aciklama_tr' ,   headerName:this.translate.instant("TEXT.aciklama_tr"),  minWidth: 175  },
        { field: 'aciklama_en' ,   headerName:this.translate.instant("TEXT.aciklama_en"), sortable: true , cellStyle: {color: '#ccce75'}},
